export const styles = {
  ...
  heading1:
    "font-montserrat font-semibold xs:text-[60px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full",
  heading2:
    "font-montserrat font-semibold xs:text-[42px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full",
